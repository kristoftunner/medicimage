...
MyFrame::MyFrame() 
{
    ...
    Bind(EVT_PATIENT_SELECTED, [thumbnails](PatientSelectedEvent &event) { wxPostEvent(thumbnails, event); });
    ...
    Bind(EVT_EDITOR_ENTITY_CHANGED,
         [this, attributeEditor](EntityEvent &event) { wxPostEvent(attributeEditor, event); });
