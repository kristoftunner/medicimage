  ...
  : wxFrame(NULL, wxID_ANY, "")
{
  ...
  toolboxSplitter->SplitHorizontally(toolbox, attributeEditor, 300);
  ...
  auto relayToolboxButtonEvent = [this](ToolboxButtonEvent& event) {
  ...
  Bind(EVT_PATIENT_SELECTED, [thumbnails](PatientSelectedEvent& event) {
  ...
  Bind(EVT_THUMBNAILS_ADD_PATIENT, [this, thumbnails](PatientSelectedEvent& event) {wxPostEvent(thumbnails, event); });
  ...
  auto relayCanvasButtonDisableEvent = [this, toolbox](ToolboButtonStateUpdateEvent& event) {wxPostEvent(toolbox, event); };
