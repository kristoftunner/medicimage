...
MyFrame::MyFrame()
{
    Create(nullptr, wxID_ANY, "MacroShot");
    ...
    wxMenuItem *appFolderConfig = new wxMenuItem(settings, wxID_ANY, "Macroscopic images folder");
    Bind(
        wxEVT_MENU,
        [this, thumbnails](wxCommandEvent &event) {
            wxDirDialog dlg(this, "Choose Macroscopic images", "", wxDD_DEFAULT_STYLE | wxDD_DIR_MUST_EXIST);
    ...
    Bind(EDITOR_ZOOM_LEVEL_CHANGED, [this, toolbox](ZoomLevelEvent &event) { wxPostEvent(toolbox, event); });
