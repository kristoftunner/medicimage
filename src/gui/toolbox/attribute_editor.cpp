...
AttributeEditor::AttributeEditor(wxWindow *parent, DocumentController& controller)
  : wxScrolled<wxPanel>(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL), m_documentController(controller)
{
...
void AttributeEditor::OnEntityAttributeChange(EntityEvent &event)
{
  ...
  if(optionalEntity.has_value())
  {
    ...
    if(entity.HasComponent<ThicknessComponent>())
    {
      ...
      m_gridSizer->Add(thicknessText, wxSizerFlags(0).Align(wxALIGN_RIGHT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(thicknessPicker, wxSizerFlags(1).Align(wxALIGN_LEFT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
    ...
    if(entity.HasComponent<TextComponent>())
    {
      ...
      m_gridSizer->Add(fontSizeText, wxSizerFlags(0).Align(wxALIGN_RIGHT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      // TODO: add min-max values
      ...
      m_gridSizer->Add(fontSizePicker, wxSizerFlags(1).Align(wxALIGN_LEFT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
    ...
    if(entity.HasComponent<SkinTemplateComponent>())
    {
      ...
      m_gridSizer->Add(verticalSliceCountText, wxSizerFlags(0).Align(wxALIGN_RIGHT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(verticalSliceCountPicker, wxSizerFlags(1).Align(wxALIGN_LEFT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(leftHorSliceCountText, wxSizerFlags(0).Align(wxALIGN_RIGHT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(leftHorSliceCountPicker, wxSizerFlags(1).Align(wxALIGN_LEFT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(rightHorSliceCountText, wxSizerFlags(0).Align(wxALIGN_RIGHT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
      ...
      m_gridSizer->Add(rightHorSliceCountPicker, wxSizerFlags(1).Align(wxALIGN_LEFT | wxALIGN_TOP).Border(wxALL, FromDIP(2)));
