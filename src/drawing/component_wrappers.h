...
class BaseDrawComponentWrapper
{
  public:
    ...
    bool IsComposed()
    {
        return m_entity.GetComponent<CommonAttributesComponent>().composed;
    }
    Entity GetEntity()
    {
        return m_entity;
...
class RectangleComponentWrapper : public BaseDrawComponentWrapper
{
  public:
    ...
    /// @return Entity containing the components needed for describing a rectangle, TODO: should we return with
    /// RectangleComponentWrapper
...
class CircleComponentWrapper : public BaseDrawComponentWrapper
{
  public:
    ...
    /// @param baseEntity base entity to which we add all the other components
    /// @return Entity containing the components needed for describing a circle, TODO: should we return with
    /// CircleComponentWrapper
    static Entity CreateCircle(glm::vec2 firstPoint, glm::vec2 secondPoint, float aspectRatio,
...
class ArrowComponentWrapper : public BaseDrawComponentWrapper
{
  public:
    ...
    /// @param baseEntity base entity to which we add all the other components
    /// @return Entity containing the components needed for describing an arrow, TODO: should we return with
...
class TextComponentWrapper : public BaseDrawComponentWrapper
{
  public:
    ...
    static Entity CreateText(glm::vec2 firstPoint, const glm::vec2 sheetSize, const std::string &inputText,
...
class SkinTemplateComponentWrapper : public BaseDrawComponentWrapper
{
  public:
    ...
    /// @param baseEntity base entity to which we add all the other components
    /// @return Entity containing the components needed for describing an skin temaplte, TODO: should we return with
    /// SkinTemplateComponentWrapper
  ...
  private:
    ...
    static constexpr float s_minimumSliceSize = 0.015f;

    static constexpr int s_defaultVerticalCount = 3;
    static constexpr float s_maxVerticalWidthSpan = 0.7f;
    static constexpr float s_minVerticalWidthSpan = 0.3f;
    static constexpr float s_defaultVerticalWidthSpan = 0.5f;

    static constexpr int s_defaultHorizontalCount = 2;
    static constexpr float s_maxHorizontalHeightSpan = 0.8f;
    static constexpr float s_minHorizontalHeightSpan = 0.2f;
    static constexpr float s_defaultHorizontalHeightSpan = 0.5f;
    static constexpr float s_maxHorizontalWidthSpan = 0.8f;
    static constexpr float s_minHorizontalWidthSpan = 0.2f;
};
} // namespace medicimage
